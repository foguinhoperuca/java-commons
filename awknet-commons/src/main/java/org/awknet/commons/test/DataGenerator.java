...
public class DataGenerator {
	...
	public static String URL_CONNECTION = "jdbc:mysql://localhost:3306/MICASA";
	public static String FOREIGN_KEY_DOWN = "?sessionVariables=FOREIGN_KEY_CHECKS=0";
	public static String URL_FOREIGN_KEY_DOWN = URL_CONNECTION
			+ FOREIGN_KEY_DOWN;
	public static String USER = "root";
	public static String PASSWORD = "A12345678a";
