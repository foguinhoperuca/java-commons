...
public class RetrieveCodeException extends Exception {
    ...
    public static String MSG_LOGIN_ERROR = "NOSENSE a user with PASSWORD!";
    public static String MSG_EMAIL_ERROR = "user without PASSWORD in DB!";
    public static String MSG_IP_ERROR = "[RETRIEVE CODE EXCEPTION] IP was null but is MANDATORY!";
    public static String MSG_DATE_ERROR = "NOSENSE a user with PASSWORD!";
